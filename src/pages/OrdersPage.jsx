              ...
              <div className="relative z-10 w-full max-w-2xl rounded-2xl border bg-white p-4 shadow-xl">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-lg font-semibold">
                    Order #{active.order_number || active.id}
                  </div>
                  <button
                    onClick={() => setOpen(false)}
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      <span className="text-slate-500">Total:</span> KWD{" "}
                      {Number(active.total_kwd || 0).toFixed(3)}
                    </div>
                    <div>
                    ...
                    <div className="sm:col-span-2 break-words whitespace-pre-wrap">
